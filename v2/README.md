...
![build status](https://github.com/bluebat1/mqtt/actions/workflows/build.yml/badge.svg) 
[![Coverage Status](https://coveralls.io/repos/github/bluebat1/mqtt/badge.svg?branch=master&v2)](https://coveralls.io/github/bluebat1/mqtt?branch=master)
[![Go Report Card](https://goreportcard.com/badge/github.com/bluebat1/mqtt)](https://goreportcard.com/report/github.com/bluebat1/mqtt/v2)
[![Go Reference](https://pkg.go.dev/badge/github.com/bluebat1/mqtt.svg)](https://pkg.go.dev/github.com/bluebat1/mqtt/v2)
[![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/bluebat1/mqtt/issues)
...
```go
import "github.com/bluebat1/mqtt/v2"
```
...
## Roadmap
- Please [open an issue](https://github.com/bluebat1/mqtt/issues) to request new features or event hooks!
- Cluster support.
...
import (
  ...
  "github.com/bluebat1/mqtt/v2"
  "github.com/bluebat1/mqtt/v2/hooks/auth"
  "github.com/bluebat1/mqtt/v2/listeners"
)
...
| Type | Import | Info |
| -- | -- |  -- |
| Access Control | [bluebat1/mqtt/hooks/auth . AllowHook](hooks/auth/allow_all.go) | Allow access to all connecting clients and read/write to  all topics. | 
| Access Control | [bluebat1/mqtt/hooks/auth . Auth](hooks/auth/auth.go) | Rule-based access control ledger.  | 
| Persistence | [bluebat1/mqtt/hooks/storage/bolt](hooks/storage/bolt/bolt.go)  | Persistent storage using [BoltDB](https://dbdb.io/db/boltdb) (deprecated). | 
| Persistence | [bluebat1/mqtt/hooks/storage/badger](hooks/storage/badger/badger.go) | Persistent storage using [BadgerDB](https://github.com/dgraph-io/badger). | 
| Persistence | [bluebat1/mqtt/hooks/storage/redis](hooks/storage/redis/redis.go)  | Persistent storage using [Redis](https://redis.io). | 
| Debugging | [bluebat1/mqtt/hooks/debug](hooks/debug/debug.go) | Additional debugging output to visualise packet flow. | 

Many of the internal server functions are now exposed to developers, so you can make your own Hooks by using the above as examples. If you do, please [Open an issue](https://github.com/bluebat1/mqtt/issues) and let everyone know!
...
[![Stargazers over time](https://starchart.cc/bluebat1/mqtt.svg)](https://starchart.cc/bluebat1/mqtt)
Are you using Mochi MQTT in a project? [Let us know!](https://github.com/bluebat1/mqtt/issues)

## Contributions
Contributions and feedback are both welcomed and encouraged! [Open an issue](https://github.com/bluebat1/mqtt/issues) to report a bug, ask a question, or make a feature request.
